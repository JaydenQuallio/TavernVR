...
namespace Autohand{
    ...
    public class Teleporter : MonoBehaviour{
        ...
        bool hitting;
        RaycastHit aimHit;
        List<HandTeleportGuard> teleportGuards = new List<HandTeleportGuard>();
        ...
        private void Start() {
            ...
            teleportGuards = FindObjectsOfType<HandTeleportGuard>().ToList();
        }
        ...
        public void Teleport(){
            teleportGuards.RemoveAll(x => x == null);
